classdef NonlinearComplementarityConstraint_original < CompositeConstraint
  % NonlinearComplementarityConstraint_original
  ...
  methods
    ...
    function obj = NonlinearComplementarityConstraint_original(fun,xdim,zdim,mode,slack)
      if nargin < 4
        mode = 1;
      end
      if nargin < 5
