classdef LinearComplementarityConstraint_original < CompositeConstraint
  % LinearComplementarityConstraint_original
  ...
  methods
    ...
    function obj = LinearComplementarityConstraint_original(W,q,M,mode,slack)
      zdim = size(W,2);
