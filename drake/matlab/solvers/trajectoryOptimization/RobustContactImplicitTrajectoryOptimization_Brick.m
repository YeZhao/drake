...
%                 end
                ...
                for j=k:-1:1
                    ...
                    dmeanRdx(j,:,k+1) = dmeanRdx(j,:,k+1) + 2*(x(:,k+1)-x_mean(:,k+1))'*(eye(obj.nx)-w_averg*dSig_m_kplus1_dx_sum);
...
%             end
            ...
            [c_numeric,dc_numeric] = geval(@(x_full, Fext_full) robustVariancecost_check(obj,x_full, Fext_full),x_full, Fext_full,struct('grad_method','numerical'));
