 classdef RobustSamplingDirtranTrajectoryOptimization < DirectTrajectoryOptimization_Dirtrel
  ...
  methods
    function obj = RobustSamplingDirtranTrajectoryOptimization(plant,N,D,E0,Q,R,Qf,duration,options)
      ...
      obj = obj@DirectTrajectoryOptimization_Dirtrel(plant,N,duration,options);
    ...
    function obj = addDynamicConstraints(obj)
      ...
      switch obj.options.integration_method
        case RobustSamplingDirtranTrajectoryOptimization.FORWARD_EULER
          n_vars = 2*nX + nU + 1;
          cnstr = FunctionHandleConstraint(zeros(nX,1),zeros(nX,1),n_vars,@obj.forward_constraint_fun);
        case RobustSamplingDirtranTrajectoryOptimization.MIDPOINT
          n_vars = 2*nX + nU + 1;
          cnstr = FunctionHandleConstraint(zeros(nX,1),zeros(nX,1),n_vars,@obj.midpoint_constraint_fun);
        otherwise
          error('Drake:RobustSamplingDirtranTrajectoryOptimization:InvalidArgument','Unknown integration method');
      end
