classdef KukaArmPlant_J6 < Manipulator 
  ...
  methods
    function obj = KukaArmPlant_J6
      obj = obj@Manipulator(1,1);%[To Be Checked]
      obj = setInputLimits(obj,-10,10);%[To Be Checked]

      obj = setInputFrame(obj,CoordinateFrame('KukaArmInput',1,'u',{'tau6'}));
      obj = setStateFrame(obj,CoordinateFrame('KukaArmState',2,'x',{'theta6', ...
                                                'theta6dot'}));
      obj = setOutputFrame(obj,obj.getStateFrame);
      
      obj.xG = Point(obj.getStateFrame,[0;0]);%[To Be Checked]
...
%       H = [h11,h12;h21,h22];
      ...
      H = I7yy + I6zz + (9*m6)/25000000 + (10201*m7)/1000000;
      toc
