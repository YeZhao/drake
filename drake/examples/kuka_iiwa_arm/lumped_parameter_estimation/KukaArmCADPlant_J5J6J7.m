classdef KukaArmCADPlant_J5J6J7 < Manipulator 
  ...
  methods
    function obj = KukaArmCADPlant_J5J6J7
      ...
      obj.xG = Point(obj.getStateFrame,[0;0;0;0;0;0]);
    ...
    function [T,U] = energy(obj,x)
      ...
      % [To be updated for joint 5 to joint 7]
