function paramEstSyntheticData_KukaArm_J2toJ7_static_test
clear all

tmp = addpathTemporary(fullfile(pwd,'..'));

%% read arm data
path = '~/kuka-dev-estimation/drake/drake/examples/kuka_iiwa_arm/experiment_data/static_test/J2toJ7_extensive_data';
