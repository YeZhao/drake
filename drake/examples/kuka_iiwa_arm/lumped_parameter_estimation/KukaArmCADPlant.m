classdef KukaArmCADPlant < Manipulator 
  ...
  methods
    function obj = KukaArmCADPlant
      ...
      % used for KukaArm_J2toJ7_static_test
      obj = setParamFrame(obj,CoordinateFrame('KukaArmParams',10,'p',...
          {'m2','m3','m4','m5','c2x', 'c2y','c3y','c3z','c4y','c4z'}));
%       % used for KukaArm_J5toJ7_static_test
%       obj = setParamFrame(obj,CoordinateFrame('KukaArmParams',9,'p',...
%           {'m5','m6','m7', 'c6y', 'c5x', 'c5y', 'c5z', 'c6z', 'c7z'}));
