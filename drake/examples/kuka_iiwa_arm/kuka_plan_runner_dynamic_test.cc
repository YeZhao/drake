  ...
  void Run() {
    ...
    while (true) {
      ...
      if (qtraj_) {
        ...
        if ((fabs(qd_meas(1)) > tolerance) || (fabs(qd_meas(2)) > tolerance) || (fabs(qd_meas(3)) > tolerance) || (fabs(qd_meas(4)) > tolerance) || (fabs(qd_meas(5)) > tolerance) || (fabs(qd_meas(6)) > tolerance)){
